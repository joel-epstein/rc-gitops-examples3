...
Cranberry_112: {
	...
	config: [
		...
		// Cranberry_112 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_112 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-112/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-112$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-112
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-112 proxy object. All configs
