...
Blueberry_104: {
	...
	config: [
		...
		// Blueberry_104 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_104 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-104/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-104$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-104
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-104 proxy object. All configs
