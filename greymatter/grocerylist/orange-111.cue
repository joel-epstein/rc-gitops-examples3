...
Orange_111: {
	...
	config: [
		...
		// Orange_111 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_111 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-111/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-111$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-111
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-111 proxy object. All configs
