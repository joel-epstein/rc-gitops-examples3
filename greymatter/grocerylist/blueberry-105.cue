...
Blueberry_105: {
	...
	config: [
		...
		// Blueberry_105 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_105 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-105/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-105$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-105
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-105 proxy object. All configs
