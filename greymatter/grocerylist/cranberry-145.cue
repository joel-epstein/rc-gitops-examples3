...
Cranberry_145: {
	...
	config: [
		...
		// Cranberry_145 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_145 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-145/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-145$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-145
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-145 proxy object. All configs
