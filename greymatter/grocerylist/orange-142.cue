...
Orange_142: {
	...
	config: [
		...
		// Orange_142 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_142 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-142/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-142$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-142
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-142 proxy object. All configs
