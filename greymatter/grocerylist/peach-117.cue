...
Peach_117: {
	...
	config: [
		...
		// Peach_117 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_117 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-117/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-117$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-117
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-117 proxy object. All configs
