...
Blueberry_101: {
	...
	config: [
		...
		// Blueberry_101 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_101 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-101/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-101$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-101
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-101 proxy object. All configs
