...
Melon_131: {
	...
	config: [
		...
		// Melon_131 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_131 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-131/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-131$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-131
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-131 proxy object. All configs
