...
Peach_29: {
	...
	config: [
		...
		// Peach_29 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_29 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-29/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-29$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-29
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-29 proxy object. All configs
