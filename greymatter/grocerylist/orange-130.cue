...
Orange_130: {
	...
	config: [
		...
		// Orange_130 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_130 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-130/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-130$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-130
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-130 proxy object. All configs
