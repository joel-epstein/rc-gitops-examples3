...
Grape_147: {
	...
	config: [
		...
		// Grape_147 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_147 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-147/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-147$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-147
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-147 proxy object. All configs
