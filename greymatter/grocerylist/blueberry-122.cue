...
Blueberry_122: {
	...
	config: [
		...
		// Blueberry_122 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_122 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-122/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-122$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-122
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-122 proxy object. All configs
