...
Tangerine_129: {
	...
	config: [
		...
		// Tangerine_129 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_129 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-129/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-129$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-129
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-129 proxy object. All configs
