...
Orange_110: {
	...
	config: [
		...
		// Orange_110 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_110 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-110/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-110$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-110
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-110 proxy object. All configs
