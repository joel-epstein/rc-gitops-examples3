...
Cranberry_142: {
	...
	config: [
		...
		// Cranberry_142 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_142 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-142/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-142$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-142
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-142 proxy object. All configs
