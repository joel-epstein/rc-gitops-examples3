...
Blueberry_109: {
	...
	config: [
		...
		// Blueberry_109 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_109 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-109/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-109$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-109
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-109 proxy object. All configs
