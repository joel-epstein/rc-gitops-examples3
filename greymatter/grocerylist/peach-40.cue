...
Peach_40: {
	...
	config: [
		...
		// Peach_40 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_40 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-40/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-40$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-40
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-40 proxy object. All configs
