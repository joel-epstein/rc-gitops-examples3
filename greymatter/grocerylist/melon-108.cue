...
Melon_108: {
	...
	config: [
		...
		// Melon_108 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_108 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-108/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-108$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-108
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-108 proxy object. All configs
