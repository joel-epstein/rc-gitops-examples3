...
Peach_135: {
	...
	config: [
		...
		// Peach_135 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_135 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-135/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-135$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-135
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-135 proxy object. All configs
