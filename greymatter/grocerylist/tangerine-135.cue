...
Tangerine_135: {
	...
	config: [
		...
		// Tangerine_135 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_135 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-135/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-135$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-135
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-135 proxy object. All configs
