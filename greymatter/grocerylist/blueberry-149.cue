...
Blueberry_149: {
	...
	config: [
		...
		// Blueberry_149 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_149 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-149/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-149$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-149
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-149 proxy object. All configs
