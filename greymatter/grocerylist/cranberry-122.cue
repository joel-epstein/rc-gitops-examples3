...
Cranberry_122: {
	...
	config: [
		...
		// Cranberry_122 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_122 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-122/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-122$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-122
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-122 proxy object. All configs
