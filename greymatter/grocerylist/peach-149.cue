...
Peach_149: {
	...
	config: [
		...
		// Peach_149 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_149 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-149/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-149$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-149
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-149 proxy object. All configs
