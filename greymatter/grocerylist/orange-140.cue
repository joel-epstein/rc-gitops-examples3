...
Orange_140: {
	...
	config: [
		...
		// Orange_140 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_140 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-140/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-140$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-140
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-140 proxy object. All configs
