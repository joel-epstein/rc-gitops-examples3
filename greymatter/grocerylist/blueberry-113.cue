...
Blueberry_113: {
	...
	config: [
		...
		// Blueberry_113 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_113 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-113/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-113$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-113
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-113 proxy object. All configs
