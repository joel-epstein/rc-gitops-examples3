...
Orange_113: {
	...
	config: [
		...
		// Orange_113 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_113 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-113/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-113$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-113
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-113 proxy object. All configs
