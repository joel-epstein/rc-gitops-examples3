...
Orange_138: {
	...
	config: [
		...
		// Orange_138 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_138 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-138/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-138$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-138
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-138 proxy object. All configs
