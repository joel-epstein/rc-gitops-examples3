...
Melon_138: {
	...
	config: [
		...
		// Melon_138 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_138 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-138/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-138$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-138
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-138 proxy object. All configs
