...
Peach_14: {
	...
	config: [
		...
		// Peach_14 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_14 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-14/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-14$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-14
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-14 proxy object. All configs
