...
Melon_125: {
	...
	config: [
		...
		// Melon_125 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_125 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-125/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-125$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-125
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-125 proxy object. All configs
