...
Peach_39: {
	...
	config: [
		...
		// Peach_39 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_39 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-39/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-39$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-39
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-39 proxy object. All configs
