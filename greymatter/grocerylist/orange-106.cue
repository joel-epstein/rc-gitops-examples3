...
Orange_106: {
	...
	config: [
		...
		// Orange_106 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_106 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-106/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-106$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-106
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-106 proxy object. All configs
