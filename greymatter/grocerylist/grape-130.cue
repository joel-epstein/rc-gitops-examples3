...
Grape_130: {
	...
	config: [
		...
		// Grape_130 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_130 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-130/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-130$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-130
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-130 proxy object. All configs
