...
Melon_135: {
	...
	config: [
		...
		// Melon_135 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_135 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-135/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-135$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-135
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-135 proxy object. All configs
