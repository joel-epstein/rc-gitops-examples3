...
Tangerine_114: {
	...
	config: [
		...
		// Tangerine_114 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_114 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-114/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-114$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-114
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-114 proxy object. All configs
