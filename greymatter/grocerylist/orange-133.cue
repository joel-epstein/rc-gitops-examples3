...
Orange_133: {
	...
	config: [
		...
		// Orange_133 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_133 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-133/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-133$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-133
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-133 proxy object. All configs
