...
Cranberry_121: {
	...
	config: [
		...
		// Cranberry_121 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_121 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-121/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-121$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-121
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-121 proxy object. All configs
