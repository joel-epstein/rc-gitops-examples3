...
Orange_134: {
	...
	config: [
		...
		// Orange_134 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_134 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-134/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-134$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-134
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-134 proxy object. All configs
