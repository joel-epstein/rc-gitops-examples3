...
Melon_104: {
	...
	config: [
		...
		// Melon_104 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_104 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-104/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-104$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-104
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-104 proxy object. All configs
