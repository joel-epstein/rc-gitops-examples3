...
Tangerine_145: {
	...
	config: [
		...
		// Tangerine_145 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_145 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-145/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-145$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-145
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-145 proxy object. All configs
