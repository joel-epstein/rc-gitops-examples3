...
Peach_62: {
	...
	config: [
		...
		// Peach_62 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_62 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-62/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-62$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-62
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-62 proxy object. All configs
