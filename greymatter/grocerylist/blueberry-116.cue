...
Blueberry_116: {
	...
	config: [
		...
		// Blueberry_116 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_116 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-116/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-116$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-116
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-116 proxy object. All configs
