...
Grape_124: {
	...
	config: [
		...
		// Grape_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-124
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-124 proxy object. All configs
