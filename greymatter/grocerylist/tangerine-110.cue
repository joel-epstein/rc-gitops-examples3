...
Tangerine_110: {
	...
	config: [
		...
		// Tangerine_110 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_110 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-110/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-110$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-110
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-110 proxy object. All configs
