...
Orange_148: {
	...
	config: [
		...
		// Orange_148 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_148 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-148/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-148$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-148
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-148 proxy object. All configs
