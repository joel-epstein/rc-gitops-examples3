...
Cranberry_101: {
	...
	config: [
		...
		// Cranberry_101 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_101 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-101/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-101$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-101
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-101 proxy object. All configs
