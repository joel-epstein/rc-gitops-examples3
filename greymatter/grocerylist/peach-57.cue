...
Peach_57: {
	...
	config: [
		...
		// Peach_57 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_57 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-57/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-57$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-57
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-57 proxy object. All configs
