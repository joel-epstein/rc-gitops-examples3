...
Orange_131: {
	...
	config: [
		...
		// Orange_131 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_131 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-131/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-131$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-131
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-131 proxy object. All configs
