...
Tangerine_122: {
	...
	config: [
		...
		// Tangerine_122 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_122 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-122/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-122$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-122
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-122 proxy object. All configs
