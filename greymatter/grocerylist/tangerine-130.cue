...
Tangerine_130: {
	...
	config: [
		...
		// Tangerine_130 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_130 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-130/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-130$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-130
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-130 proxy object. All configs
