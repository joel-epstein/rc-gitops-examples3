...
Tangerine_142: {
	...
	config: [
		...
		// Tangerine_142 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_142 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-142/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-142$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-142
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-142 proxy object. All configs
