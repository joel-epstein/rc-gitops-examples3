...
Melon_122: {
	...
	config: [
		...
		// Melon_122 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_122 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-122/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-122$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-122
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-122 proxy object. All configs
