...
Melon_117: {
	...
	config: [
		...
		// Melon_117 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_117 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-117/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-117$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-117
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-117 proxy object. All configs
