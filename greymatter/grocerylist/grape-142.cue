...
Grape_142: {
	...
	config: [
		...
		// Grape_142 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_142 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-142/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-142$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-142
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-142 proxy object. All configs
