...
Peach_27: {
	...
	config: [
		...
		// Peach_27 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_27 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-27/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-27$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-27
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-27 proxy object. All configs
