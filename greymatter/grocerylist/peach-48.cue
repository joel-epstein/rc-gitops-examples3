...
Peach_48: {
	...
	config: [
		...
		// Peach_48 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_48 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-48/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-48$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-48
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-48 proxy object. All configs
