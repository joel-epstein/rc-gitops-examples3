...
Melon_144: {
	...
	config: [
		...
		// Melon_144 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_144 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-144/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-144$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-144
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-144 proxy object. All configs
