...
Tangerine_125: {
	...
	config: [
		...
		// Tangerine_125 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_125 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-125/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-125$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-125
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-125 proxy object. All configs
