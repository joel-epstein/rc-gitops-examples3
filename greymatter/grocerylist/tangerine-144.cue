...
Tangerine_144: {
	...
	config: [
		...
		// Tangerine_144 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_144 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-144/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-144$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-144
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-144 proxy object. All configs
