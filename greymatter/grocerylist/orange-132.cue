...
Orange_132: {
	...
	config: [
		...
		// Orange_132 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_132 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-132/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-132$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-132
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-132 proxy object. All configs
