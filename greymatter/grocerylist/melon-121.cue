...
Melon_121: {
	...
	config: [
		...
		// Melon_121 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_121 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-121/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-121$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-121
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-121 proxy object. All configs
