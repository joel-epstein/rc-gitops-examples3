...
Melon_139: {
	...
	config: [
		...
		// Melon_139 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_139 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-139/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-139$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-139
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-139 proxy object. All configs
