...
Cranberry_110: {
	...
	config: [
		...
		// Cranberry_110 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_110 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-110/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-110$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-110
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-110 proxy object. All configs
