...
Melon_106: {
	...
	config: [
		...
		// Melon_106 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_106 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-106/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-106$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-106
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-106 proxy object. All configs
