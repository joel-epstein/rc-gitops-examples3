...
Orange_104: {
	...
	config: [
		...
		// Orange_104 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_104 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-104/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-104$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-104
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-104 proxy object. All configs
