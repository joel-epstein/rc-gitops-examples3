...
Peach_86: {
	...
	config: [
		...
		// Peach_86 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_86 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-86/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-86$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-86
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-86 proxy object. All configs
