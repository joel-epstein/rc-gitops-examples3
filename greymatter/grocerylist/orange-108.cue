...
Orange_108: {
	...
	config: [
		...
		// Orange_108 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_108 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-108/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-108$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-108
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-108 proxy object. All configs
