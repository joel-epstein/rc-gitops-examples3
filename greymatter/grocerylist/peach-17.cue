...
Peach_17: {
	...
	config: [
		...
		// Peach_17 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_17 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-17/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-17$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-17
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-17 proxy object. All configs
