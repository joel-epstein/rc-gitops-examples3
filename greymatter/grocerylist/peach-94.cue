...
Peach_94: {
	...
	config: [
		...
		// Peach_94 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_94 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-94/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-94$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-94
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-94 proxy object. All configs
