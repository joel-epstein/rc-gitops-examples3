...
Blueberry_119: {
	...
	config: [
		...
		// Blueberry_119 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_119 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-119/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-119$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-119
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-119 proxy object. All configs
