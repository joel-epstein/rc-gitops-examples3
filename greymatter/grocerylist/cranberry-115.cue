...
Cranberry_115: {
	...
	config: [
		...
		// Cranberry_115 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_115 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-115/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-115$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-115
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-115 proxy object. All configs
