...
Cranberry_113: {
	...
	config: [
		...
		// Cranberry_113 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_113 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-113/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-113$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-113
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-113 proxy object. All configs
