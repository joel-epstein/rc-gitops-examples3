...
Cranberry_135: {
	...
	config: [
		...
		// Cranberry_135 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_135 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-135/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-135$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-135
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-135 proxy object. All configs
