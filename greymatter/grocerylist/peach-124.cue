...
Peach_124: {
	...
	config: [
		...
		// Peach_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-124
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-124 proxy object. All configs
