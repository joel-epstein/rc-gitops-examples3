...
Peach_49: {
	...
	config: [
		...
		// Peach_49 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_49 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-49/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-49$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-49
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-49 proxy object. All configs
