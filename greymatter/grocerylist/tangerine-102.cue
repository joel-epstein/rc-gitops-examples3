...
Tangerine_102: {
	...
	config: [
		...
		// Tangerine_102 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_102 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-102/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-102$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-102
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-102 proxy object. All configs
