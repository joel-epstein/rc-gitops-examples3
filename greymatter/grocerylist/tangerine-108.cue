...
Tangerine_108: {
	...
	config: [
		...
		// Tangerine_108 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_108 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-108/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-108$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-108
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-108 proxy object. All configs
