...
Tangerine_107: {
	...
	config: [
		...
		// Tangerine_107 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_107 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-107/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-107$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-107
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-107 proxy object. All configs
