...
Cranberry_102: {
	...
	config: [
		...
		// Cranberry_102 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_102 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-102/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-102$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-102
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-102 proxy object. All configs
