...
Blueberry_147: {
	...
	config: [
		...
		// Blueberry_147 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_147 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-147/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-147$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-147
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-147 proxy object. All configs
