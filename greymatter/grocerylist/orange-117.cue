...
Orange_117: {
	...
	config: [
		...
		// Orange_117 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_117 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-117/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-117$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-117
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-117 proxy object. All configs
