...
Peach_136: {
	...
	config: [
		...
		// Peach_136 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_136 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-136/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-136$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-136
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-136 proxy object. All configs
