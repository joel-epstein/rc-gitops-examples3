...
Melon_114: {
	...
	config: [
		...
		// Melon_114 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_114 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-114/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-114$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-114
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-114 proxy object. All configs
