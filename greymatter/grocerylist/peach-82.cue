...
Peach_82: {
	...
	config: [
		...
		// Peach_82 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_82 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-82/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-82$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-82
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-82 proxy object. All configs
