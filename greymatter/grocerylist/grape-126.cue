...
Grape_126: {
	...
	config: [
		...
		// Grape_126 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_126 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-126
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-126 proxy object. All configs
