...
Tangerine_147: {
	...
	config: [
		...
		// Tangerine_147 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_147 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-147/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-147$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-147
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-147 proxy object. All configs
