...
Melon_149: {
	...
	config: [
		...
		// Melon_149 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_149 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-149/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-149$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-149
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-149 proxy object. All configs
