...
Melon_101: {
	...
	config: [
		...
		// Melon_101 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_101 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-101/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-101$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-101
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-101 proxy object. All configs
