...
Blueberry_134: {
	...
	config: [
		...
		// Blueberry_134 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_134 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-134/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-134$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-134
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-134 proxy object. All configs
