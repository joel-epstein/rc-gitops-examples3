...
Melon_120: {
	...
	config: [
		...
		// Melon_120 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_120 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-120/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-120$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-120
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-120 proxy object. All configs
