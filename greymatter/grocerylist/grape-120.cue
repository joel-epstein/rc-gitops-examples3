...
Grape_120: {
	...
	config: [
		...
		// Grape_120 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_120 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-120/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-120$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-120
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-120 proxy object. All configs
