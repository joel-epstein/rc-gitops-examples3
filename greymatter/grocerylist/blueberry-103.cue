...
Blueberry_103: {
	...
	config: [
		...
		// Blueberry_103 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_103 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-103/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-103$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-103
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-103 proxy object. All configs
