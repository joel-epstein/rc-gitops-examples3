...
Tangerine_120: {
	...
	config: [
		...
		// Tangerine_120 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_120 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-120/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-120$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-120
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-120 proxy object. All configs
