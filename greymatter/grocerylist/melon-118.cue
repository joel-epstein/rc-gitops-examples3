...
Melon_118: {
	...
	config: [
		...
		// Melon_118 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_118 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-118/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-118$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-118
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-118 proxy object. All configs
