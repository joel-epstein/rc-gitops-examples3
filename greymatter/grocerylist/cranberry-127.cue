...
Cranberry_127: {
	...
	config: [
		...
		// Cranberry_127 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_127 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-127/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-127$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-127
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-127 proxy object. All configs
