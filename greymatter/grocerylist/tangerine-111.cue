...
Tangerine_111: {
	...
	config: [
		...
		// Tangerine_111 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_111 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-111/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-111$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-111
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-111 proxy object. All configs
