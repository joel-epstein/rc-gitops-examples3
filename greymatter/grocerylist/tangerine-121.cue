...
Tangerine_121: {
	...
	config: [
		...
		// Tangerine_121 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_121 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-121/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-121$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-121
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-121 proxy object. All configs
