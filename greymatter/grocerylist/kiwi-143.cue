...
Kiwi_143: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-143/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-143$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-143
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-143 proxy object. All configs
