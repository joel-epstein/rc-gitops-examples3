...
Peach_87: {
	...
	config: [
		...
		// Peach_87 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_87 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-87/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-87$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-87
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-87 proxy object. All configs
