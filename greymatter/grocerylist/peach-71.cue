...
Peach_71: {
	...
	config: [
		...
		// Peach_71 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_71 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-71/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-71$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-71
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-71 proxy object. All configs
