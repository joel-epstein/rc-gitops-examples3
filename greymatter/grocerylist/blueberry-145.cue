...
Blueberry_145: {
	...
	config: [
		...
		// Blueberry_145 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_145 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-145/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-145$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-145
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-145 proxy object. All configs
