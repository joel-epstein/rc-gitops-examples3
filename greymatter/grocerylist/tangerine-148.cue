...
Tangerine_148: {
	...
	config: [
		...
		// Tangerine_148 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_148 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-148/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-148$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-148
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-148 proxy object. All configs
