...
Cranberry_116: {
	...
	config: [
		...
		// Cranberry_116 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_116 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-116/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-116$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-116
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-116 proxy object. All configs
