...
Peach_44: {
	...
	config: [
		...
		// Peach_44 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_44 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-44/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-44$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-44
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-44 proxy object. All configs
