...
Melon_141: {
	...
	config: [
		...
		// Melon_141 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_141 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-141/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-141$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-141
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-141 proxy object. All configs
