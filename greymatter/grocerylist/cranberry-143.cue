...
Cranberry_143: {
	...
	config: [
		...
		// Cranberry_143 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_143 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-143/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-143$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-143
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-143 proxy object. All configs
