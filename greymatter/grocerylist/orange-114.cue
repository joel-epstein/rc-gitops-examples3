...
Orange_114: {
	...
	config: [
		...
		// Orange_114 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_114 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-114/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-114$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-114
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-114 proxy object. All configs
