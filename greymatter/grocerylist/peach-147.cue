...
Peach_147: {
	...
	config: [
		...
		// Peach_147 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_147 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-147/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-147$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-147
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-147 proxy object. All configs
