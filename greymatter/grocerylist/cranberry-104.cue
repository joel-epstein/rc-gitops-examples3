...
Cranberry_104: {
	...
	config: [
		...
		// Cranberry_104 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_104 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-104/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-104$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-104
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-104 proxy object. All configs
