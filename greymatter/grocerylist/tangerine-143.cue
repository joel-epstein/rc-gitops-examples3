...
Tangerine_143: {
	...
	config: [
		...
		// Tangerine_143 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_143 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-143/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-143$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-143
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-143 proxy object. All configs
