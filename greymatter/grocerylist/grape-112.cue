...
Grape_112: {
	...
	config: [
		...
		// Grape_112 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_112 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-112/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-112$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-112
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-112 proxy object. All configs
