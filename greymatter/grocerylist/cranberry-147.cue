...
Cranberry_147: {
	...
	config: [
		...
		// Cranberry_147 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_147 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-147/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-147$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-147
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-147 proxy object. All configs
