...
Cranberry_148: {
	...
	config: [
		...
		// Cranberry_148 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_148 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-148/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-148$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-148
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-148 proxy object. All configs
