...
Blueberry_125: {
	...
	config: [
		...
		// Blueberry_125 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_125 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-125/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-125$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-125
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-125 proxy object. All configs
