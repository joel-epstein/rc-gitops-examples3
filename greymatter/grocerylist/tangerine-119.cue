...
Tangerine_119: {
	...
	config: [
		...
		// Tangerine_119 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_119 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-119/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-119$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-119
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-119 proxy object. All configs
