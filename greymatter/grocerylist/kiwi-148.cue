...
Kiwi_148: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-148/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-148$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-148
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-148 proxy object. All configs
