...
Cranberry_124: {
	...
	config: [
		...
		// Cranberry_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-124
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-124 proxy object. All configs
