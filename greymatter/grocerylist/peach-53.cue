...
Peach_53: {
	...
	config: [
		...
		// Peach_53 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_53 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-53/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-53$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-53
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-53 proxy object. All configs
