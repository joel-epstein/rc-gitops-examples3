...
Cranberry_131: {
	...
	config: [
		...
		// Cranberry_131 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_131 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-131/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-131$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-131
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-131 proxy object. All configs
