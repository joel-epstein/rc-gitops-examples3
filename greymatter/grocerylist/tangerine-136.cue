...
Tangerine_136: {
	...
	config: [
		...
		// Tangerine_136 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_136 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-136/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-136$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-136
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-136 proxy object. All configs
