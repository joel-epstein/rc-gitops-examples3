...
Tangerine_131: {
	...
	config: [
		...
		// Tangerine_131 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_131 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-131/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-131$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-131
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-131 proxy object. All configs
