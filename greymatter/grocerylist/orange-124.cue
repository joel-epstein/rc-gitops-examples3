...
Orange_124: {
	...
	config: [
		...
		// Orange_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-124
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-124 proxy object. All configs
