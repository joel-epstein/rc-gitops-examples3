...
Tangerine_118: {
	...
	config: [
		...
		// Tangerine_118 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_118 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-118/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-118$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-118
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-118 proxy object. All configs
