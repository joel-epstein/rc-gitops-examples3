...
Kiwi_119: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-119/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-119$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-119
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-119 proxy object. All configs
