...
Blueberry_140: {
	...
	config: [
		...
		// Blueberry_140 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_140 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-140/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-140$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-140
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-140 proxy object. All configs
