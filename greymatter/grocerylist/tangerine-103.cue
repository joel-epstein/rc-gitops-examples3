...
Tangerine_103: {
	...
	config: [
		...
		// Tangerine_103 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_103 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-103/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-103$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-103
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-103 proxy object. All configs
