...
Cranberry_125: {
	...
	config: [
		...
		// Cranberry_125 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_125 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-125/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-125$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-125
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-125 proxy object. All configs
