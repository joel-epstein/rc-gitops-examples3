...
Tangerine_104: {
	...
	config: [
		...
		// Tangerine_104 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_104 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-104/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-104$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-104
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-104 proxy object. All configs
