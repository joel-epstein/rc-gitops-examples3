...
Cranberry_126: {
	...
	config: [
		...
		// Cranberry_126 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_126 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-126
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-126 proxy object. All configs
