...
Peach_45: {
	...
	config: [
		...
		// Peach_45 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_45 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-45/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-45$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-45
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-45 proxy object. All configs
