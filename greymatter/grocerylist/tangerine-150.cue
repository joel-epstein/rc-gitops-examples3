...
Tangerine_150: {
	...
	config: [
		...
		// Tangerine_150 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_150 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-150/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-150$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-150
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-150 proxy object. All configs
