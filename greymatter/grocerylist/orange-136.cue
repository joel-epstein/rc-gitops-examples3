...
Orange_136: {
	...
	config: [
		...
		// Orange_136 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_136 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-136/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-136$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-136
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-136 proxy object. All configs
