...
Blueberry_133: {
	...
	config: [
		...
		// Blueberry_133 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_133 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-133/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-133$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-133
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-133 proxy object. All configs
