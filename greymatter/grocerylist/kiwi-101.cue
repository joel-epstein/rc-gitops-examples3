...
Kiwi_101: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-101/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-101$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-101
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-101 proxy object. All configs
