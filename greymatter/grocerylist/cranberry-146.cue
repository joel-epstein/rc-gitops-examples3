...
Cranberry_146: {
	...
	config: [
		...
		// Cranberry_146 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_146 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-146/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-146$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-146
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-146 proxy object. All configs
