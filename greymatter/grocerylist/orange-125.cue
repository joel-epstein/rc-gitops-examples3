...
Orange_125: {
	...
	config: [
		...
		// Orange_125 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_125 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-125/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-125$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-125
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-125 proxy object. All configs
