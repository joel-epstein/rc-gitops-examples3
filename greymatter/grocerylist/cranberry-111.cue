...
Cranberry_111: {
	...
	config: [
		...
		// Cranberry_111 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_111 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-111/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-111$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-111
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-111 proxy object. All configs
