...
Orange_123: {
	...
	config: [
		...
		// Orange_123 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_123 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-123/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-123$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-123
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-123 proxy object. All configs
