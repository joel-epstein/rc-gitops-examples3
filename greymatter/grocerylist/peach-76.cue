...
Peach_76: {
	...
	config: [
		...
		// Peach_76 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_76 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-76/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-76$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-76
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-76 proxy object. All configs
