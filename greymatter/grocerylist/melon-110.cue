...
Melon_110: {
	...
	config: [
		...
		// Melon_110 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_110 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-110/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-110$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-110
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-110 proxy object. All configs
