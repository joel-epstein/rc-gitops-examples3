...
Blueberry_120: {
	...
	config: [
		...
		// Blueberry_120 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_120 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-120/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-120$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-120
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-120 proxy object. All configs
