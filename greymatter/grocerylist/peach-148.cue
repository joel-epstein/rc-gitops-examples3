...
Peach_148: {
	...
	config: [
		...
		// Peach_148 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_148 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-148/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-148$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-148
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-148 proxy object. All configs
