...
Blueberry_114: {
	...
	config: [
		...
		// Blueberry_114 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_114 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-114/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-114$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-114
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-114 proxy object. All configs
