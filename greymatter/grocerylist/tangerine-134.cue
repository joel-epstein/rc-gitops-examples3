...
Tangerine_134: {
	...
	config: [
		...
		// Tangerine_134 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_134 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-134/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-134$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-134
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-134 proxy object. All configs
