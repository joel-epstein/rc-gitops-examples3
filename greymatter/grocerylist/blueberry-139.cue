...
Blueberry_139: {
	...
	config: [
		...
		// Blueberry_139 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_139 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-139/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-139$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-139
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-139 proxy object. All configs
