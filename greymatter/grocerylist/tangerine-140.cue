...
Tangerine_140: {
	...
	config: [
		...
		// Tangerine_140 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_140 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-140/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-140$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-140
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-140 proxy object. All configs
