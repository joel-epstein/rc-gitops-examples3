...
Cranberry_130: {
	...
	config: [
		...
		// Cranberry_130 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_130 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-130/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-130$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-130
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-130 proxy object. All configs
