...
Blueberry_111: {
	...
	config: [
		...
		// Blueberry_111 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_111 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-111/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-111$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-111
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-111 proxy object. All configs
