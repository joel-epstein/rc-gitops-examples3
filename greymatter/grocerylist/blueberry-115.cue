...
Blueberry_115: {
	...
	config: [
		...
		// Blueberry_115 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_115 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-115/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-115$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-115
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-115 proxy object. All configs
