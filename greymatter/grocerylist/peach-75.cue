...
Peach_75: {
	...
	config: [
		...
		// Peach_75 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_75 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-75/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-75$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-75
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-75 proxy object. All configs
