...
Kiwi_111: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-111/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-111$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-111
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-111 proxy object. All configs
