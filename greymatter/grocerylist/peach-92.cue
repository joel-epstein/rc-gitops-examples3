...
Peach_92: {
	...
	config: [
		...
		// Peach_92 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_92 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-92/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-92$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-92
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-92 proxy object. All configs
