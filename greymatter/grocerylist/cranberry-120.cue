...
Cranberry_120: {
	...
	config: [
		...
		// Cranberry_120 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_120 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-120/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-120$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-120
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-120 proxy object. All configs
