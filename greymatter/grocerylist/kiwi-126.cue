...
Kiwi_126: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-126
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-126 proxy object. All configs
