...
Cranberry_140: {
	...
	config: [
		...
		// Cranberry_140 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_140 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-140/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-140$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-140
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-140 proxy object. All configs
