...
Peach_41: {
	...
	config: [
		...
		// Peach_41 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_41 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-41/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-41$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-41
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-41 proxy object. All configs
