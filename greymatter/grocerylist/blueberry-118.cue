...
Blueberry_118: {
	...
	config: [
		...
		// Blueberry_118 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_118 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-118/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-118$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-118
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-118 proxy object. All configs
