...
Orange_141: {
	...
	config: [
		...
		// Orange_141 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_141 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-141/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-141$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-141
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-141 proxy object. All configs
