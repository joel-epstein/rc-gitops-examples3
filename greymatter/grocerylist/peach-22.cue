...
Peach_22: {
	...
	config: [
		...
		// Peach_22 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_22 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-22/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-22$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-22
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-22 proxy object. All configs
