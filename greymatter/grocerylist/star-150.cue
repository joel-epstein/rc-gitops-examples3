...
Star_150: {
	...
	config: [
		...
		// Star_150 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_150 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-150/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-150$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-150
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-150 proxy object. All configs
