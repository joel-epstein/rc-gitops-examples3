...
Cranberry_117: {
	...
	config: [
		...
		// Cranberry_117 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_117 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-117/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-117$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-117
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-117 proxy object. All configs
