...
Orange_118: {
	...
	config: [
		...
		// Orange_118 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_118 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-118/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-118$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-118
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-118 proxy object. All configs
