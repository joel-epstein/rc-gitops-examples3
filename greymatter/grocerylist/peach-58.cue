...
Peach_58: {
	...
	config: [
		...
		// Peach_58 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_58 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-58/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-58$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-58
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-58 proxy object. All configs
