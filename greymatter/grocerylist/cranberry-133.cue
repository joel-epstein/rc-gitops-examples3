...
Cranberry_133: {
	...
	config: [
		...
		// Cranberry_133 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_133 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-133/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-133$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-133
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-133 proxy object. All configs
