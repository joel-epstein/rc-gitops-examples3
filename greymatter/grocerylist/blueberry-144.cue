...
Blueberry_144: {
	...
	config: [
		...
		// Blueberry_144 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_144 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-144/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-144$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-144
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-144 proxy object. All configs
