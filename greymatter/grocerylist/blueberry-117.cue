...
Blueberry_117: {
	...
	config: [
		...
		// Blueberry_117 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_117 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-117/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-117$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-117
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-117 proxy object. All configs
