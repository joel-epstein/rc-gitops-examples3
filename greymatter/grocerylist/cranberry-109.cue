...
Cranberry_109: {
	...
	config: [
		...
		// Cranberry_109 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_109 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-109/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-109$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-109
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-109 proxy object. All configs
