...
Tangerine_132: {
	...
	config: [
		...
		// Tangerine_132 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_132 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-132/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-132$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-132
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-132 proxy object. All configs
