...
Orange_143: {
	...
	config: [
		...
		// Orange_143 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_143 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-143/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-143$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-143
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-143 proxy object. All configs
