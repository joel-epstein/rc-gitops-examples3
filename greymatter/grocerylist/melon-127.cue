...
Melon_127: {
	...
	config: [
		...
		// Melon_127 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_127 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-127/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-127$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-127
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-127 proxy object. All configs
