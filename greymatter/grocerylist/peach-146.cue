...
Peach_146: {
	...
	config: [
		...
		// Peach_146 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_146 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-146/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-146$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-146
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-146 proxy object. All configs
