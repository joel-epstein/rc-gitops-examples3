...
Tangerine_101: {
	...
	config: [
		...
		// Tangerine_101 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_101 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-101/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-101$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-101
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-101 proxy object. All configs
