...
Blueberry_143: {
	...
	config: [
		...
		// Blueberry_143 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_143 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-143/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-143$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-143
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-143 proxy object. All configs
