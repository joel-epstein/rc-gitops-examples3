...
Kiwi_115: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-115/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-115$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-115
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-115 proxy object. All configs
