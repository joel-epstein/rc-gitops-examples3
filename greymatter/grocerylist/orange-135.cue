...
Orange_135: {
	...
	config: [
		...
		// Orange_135 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_135 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-135/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-135$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-135
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-135 proxy object. All configs
