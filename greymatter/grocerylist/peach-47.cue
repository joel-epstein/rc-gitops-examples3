...
Peach_47: {
	...
	config: [
		...
		// Peach_47 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_47 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-47/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-47$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-47
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-47 proxy object. All configs
