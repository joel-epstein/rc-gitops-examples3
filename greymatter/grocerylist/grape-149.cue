...
Grape_149: {
	...
	config: [
		...
		// Grape_149 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_149 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-149/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-149$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-149
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-149 proxy object. All configs
