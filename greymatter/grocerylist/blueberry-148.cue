...
Blueberry_148: {
	...
	config: [
		...
		// Blueberry_148 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_148 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-148/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-148$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-148
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-148 proxy object. All configs
