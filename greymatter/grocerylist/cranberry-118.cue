...
Cranberry_118: {
	...
	config: [
		...
		// Cranberry_118 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_118 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-118/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-118$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-118
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-118 proxy object. All configs
