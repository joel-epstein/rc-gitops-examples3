...
Melon_109: {
	...
	config: [
		...
		// Melon_109 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_109 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-109/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-109$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-109
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-109 proxy object. All configs
