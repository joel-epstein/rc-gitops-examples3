...
Cranberry_103: {
	...
	config: [
		...
		// Cranberry_103 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_103 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-103/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-103$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-103
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-103 proxy object. All configs
