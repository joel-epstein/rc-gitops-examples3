...
Melon_133: {
	...
	config: [
		...
		// Melon_133 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_133 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-133/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-133$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-133
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-133 proxy object. All configs
