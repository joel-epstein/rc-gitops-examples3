...
Orange_119: {
	...
	config: [
		...
		// Orange_119 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_119 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-119/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-119$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-119
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-119 proxy object. All configs
