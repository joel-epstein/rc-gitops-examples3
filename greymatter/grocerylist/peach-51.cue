...
Peach_51: {
	...
	config: [
		...
		// Peach_51 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_51 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-51/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-51$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-51
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-51 proxy object. All configs
