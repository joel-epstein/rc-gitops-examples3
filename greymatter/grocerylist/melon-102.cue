...
Melon_102: {
	...
	config: [
		...
		// Melon_102 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_102 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-102/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-102$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-102
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-102 proxy object. All configs
