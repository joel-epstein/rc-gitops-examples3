...
Blueberry_130: {
	...
	config: [
		...
		// Blueberry_130 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_130 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-130/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-130$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-130
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-130 proxy object. All configs
