...
Orange_127: {
	...
	config: [
		...
		// Orange_127 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_127 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-127/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-127$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-127
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-127 proxy object. All configs
