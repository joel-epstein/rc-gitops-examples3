...
Orange_126: {
	...
	config: [
		...
		// Orange_126 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_126 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-126
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-126 proxy object. All configs
