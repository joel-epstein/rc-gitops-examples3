...
Peach_137: {
	...
	config: [
		...
		// Peach_137 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_137 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-137/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-137$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-137
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-137 proxy object. All configs
