...
Melon_150: {
	...
	config: [
		...
		// Melon_150 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_150 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-150/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-150$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-150
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-150 proxy object. All configs
