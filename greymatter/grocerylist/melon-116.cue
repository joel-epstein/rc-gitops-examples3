...
Melon_116: {
	...
	config: [
		...
		// Melon_116 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_116 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-116/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-116$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-116
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-116 proxy object. All configs
