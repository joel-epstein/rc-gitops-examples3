...
Cranberry_144: {
	...
	config: [
		...
		// Cranberry_144 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_144 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-144/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-144$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-144
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-144 proxy object. All configs
