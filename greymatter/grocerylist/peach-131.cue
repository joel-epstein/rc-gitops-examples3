...
Peach_131: {
	...
	config: [
		...
		// Peach_131 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_131 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-131/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-131$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-131
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-131 proxy object. All configs
