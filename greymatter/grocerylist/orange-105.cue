...
Orange_105: {
	...
	config: [
		...
		// Orange_105 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_105 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-105/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-105$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-105
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-105 proxy object. All configs
