...
Tangerine_113: {
	...
	config: [
		...
		// Tangerine_113 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_113 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-113/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-113$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-113
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-113 proxy object. All configs
