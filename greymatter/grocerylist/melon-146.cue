...
Melon_146: {
	...
	config: [
		...
		// Melon_146 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_146 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-146/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-146$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-146
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-146 proxy object. All configs
