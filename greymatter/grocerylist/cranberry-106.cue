...
Cranberry_106: {
	...
	config: [
		...
		// Cranberry_106 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_106 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-106/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-106$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-106
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-106 proxy object. All configs
