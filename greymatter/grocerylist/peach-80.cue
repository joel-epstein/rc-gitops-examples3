...
Peach_80: {
	...
	config: [
		...
		// Peach_80 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_80 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-80/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-80$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-80
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-80 proxy object. All configs
