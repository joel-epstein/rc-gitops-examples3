...
Peach_46: {
	...
	config: [
		...
		// Peach_46 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_46 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-46/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-46$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-46
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-46 proxy object. All configs
