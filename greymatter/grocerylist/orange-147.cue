...
Orange_147: {
	...
	config: [
		...
		// Orange_147 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_147 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-147/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-147$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-147
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-147 proxy object. All configs
