...
Orange_144: {
	...
	config: [
		...
		// Orange_144 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_144 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-144/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-144$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-144
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-144 proxy object. All configs
