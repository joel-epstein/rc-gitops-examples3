...
Blueberry_123: {
	...
	config: [
		...
		// Blueberry_123 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_123 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-123/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-123$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-123
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-123 proxy object. All configs
