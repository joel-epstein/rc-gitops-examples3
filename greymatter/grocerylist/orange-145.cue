...
Orange_145: {
	...
	config: [
		...
		// Orange_145 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_145 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-145/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-145$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-145
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-145 proxy object. All configs
