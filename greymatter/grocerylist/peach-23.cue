...
Peach_23: {
	...
	config: [
		...
		// Peach_23 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_23 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-23/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-23$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-23
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-23 proxy object. All configs
