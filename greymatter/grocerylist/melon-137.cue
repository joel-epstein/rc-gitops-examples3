...
Melon_137: {
	...
	config: [
		...
		// Melon_137 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_137 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-137/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-137$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-137
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-137 proxy object. All configs
