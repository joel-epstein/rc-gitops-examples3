...
Tangerine_138: {
	...
	config: [
		...
		// Tangerine_138 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_138 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-138/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-138$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-138
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-138 proxy object. All configs
