...
Blueberry_132: {
	...
	config: [
		...
		// Blueberry_132 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_132 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-132/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-132$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-132
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-132 proxy object. All configs
