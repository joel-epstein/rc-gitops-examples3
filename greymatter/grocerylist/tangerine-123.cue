...
Tangerine_123: {
	...
	config: [
		...
		// Tangerine_123 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_123 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-123/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-123$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-123
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-123 proxy object. All configs
