...
Melon_119: {
	...
	config: [
		...
		// Melon_119 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_119 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-119/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-119$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-119
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-119 proxy object. All configs
