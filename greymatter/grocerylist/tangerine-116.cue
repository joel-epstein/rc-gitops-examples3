...
Tangerine_116: {
	...
	config: [
		...
		// Tangerine_116 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_116 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-116/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-116$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-116
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-116 proxy object. All configs
