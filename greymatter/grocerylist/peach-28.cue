...
Peach_28: {
	...
	config: [
		...
		// Peach_28 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_28 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-28/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-28$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-28
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-28 proxy object. All configs
