...
Melon_126: {
	...
	config: [
		...
		// Melon_126 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_126 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-126
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-126 proxy object. All configs
