...
Cranberry_107: {
	...
	config: [
		...
		// Cranberry_107 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_107 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-107/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-107$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-107
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-107 proxy object. All configs
