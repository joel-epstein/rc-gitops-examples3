...
Melon_134: {
	...
	config: [
		...
		// Melon_134 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_134 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-134/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-134$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-134
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-134 proxy object. All configs
