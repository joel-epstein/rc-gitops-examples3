...
Cranberry_138: {
	...
	config: [
		...
		// Cranberry_138 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_138 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-138/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-138$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-138
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-138 proxy object. All configs
