...
Blueberry_146: {
	...
	config: [
		...
		// Blueberry_146 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_146 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-146/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-146$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-146
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-146 proxy object. All configs
