...
Peach_36: {
	...
	config: [
		...
		// Peach_36 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_36 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-36/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-36$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-36
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-36 proxy object. All configs
