...
Cranberry_128: {
	...
	config: [
		...
		// Cranberry_128 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_128 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-128/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-128$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-128
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-128 proxy object. All configs
