...
Peach_111: {
	...
	config: [
		...
		// Peach_111 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_111 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-111/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-111$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-111
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-111 proxy object. All configs
