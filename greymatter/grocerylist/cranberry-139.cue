...
Cranberry_139: {
	...
	config: [
		...
		// Cranberry_139 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_139 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-139/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-139$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-139
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-139 proxy object. All configs
