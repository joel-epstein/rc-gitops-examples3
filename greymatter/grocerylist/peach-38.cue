...
Peach_38: {
	...
	config: [
		...
		// Peach_38 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_38 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-38/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-38$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-38
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-38 proxy object. All configs
