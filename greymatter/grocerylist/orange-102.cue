...
Orange_102: {
	...
	config: [
		...
		// Orange_102 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_102 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-102/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-102$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-102
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-102 proxy object. All configs
