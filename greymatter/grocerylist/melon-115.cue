...
Melon_115: {
	...
	config: [
		...
		// Melon_115 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_115 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-115/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-115$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-115
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-115 proxy object. All configs
