...
Cranberry_108: {
	...
	config: [
		...
		// Cranberry_108 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_108 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-108/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-108$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-108
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-108 proxy object. All configs
