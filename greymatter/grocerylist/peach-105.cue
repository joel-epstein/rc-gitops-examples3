...
Peach_105: {
	...
	config: [
		...
		// Peach_105 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_105 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-105/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-105$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-105
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-105 proxy object. All configs
