...
Orange_109: {
	...
	config: [
		...
		// Orange_109 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_109 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-109/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-109$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-109
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-109 proxy object. All configs
