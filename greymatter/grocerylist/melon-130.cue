...
Melon_130: {
	...
	config: [
		...
		// Melon_130 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_130 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-130/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-130$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-130
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-130 proxy object. All configs
