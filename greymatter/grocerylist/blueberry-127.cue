...
Blueberry_127: {
	...
	config: [
		...
		// Blueberry_127 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_127 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-127/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-127$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-127
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-127 proxy object. All configs
