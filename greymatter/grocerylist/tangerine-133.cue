...
Tangerine_133: {
	...
	config: [
		...
		// Tangerine_133 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_133 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-133/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-133$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-133
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-133 proxy object. All configs
