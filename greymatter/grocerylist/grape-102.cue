...
Grape_102: {
	...
	config: [
		...
		// Grape_102 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_102 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-102/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-102$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-102
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-102 proxy object. All configs
