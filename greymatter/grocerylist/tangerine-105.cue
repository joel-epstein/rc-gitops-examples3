...
Tangerine_105: {
	...
	config: [
		...
		// Tangerine_105 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_105 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-105/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-105$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-105
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-105 proxy object. All configs
