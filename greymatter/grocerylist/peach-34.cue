...
Peach_34: {
	...
	config: [
		...
		// Peach_34 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_34 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-34/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-34$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-34
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-34 proxy object. All configs
