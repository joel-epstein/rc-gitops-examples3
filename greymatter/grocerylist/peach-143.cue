...
Peach_143: {
	...
	config: [
		...
		// Peach_143 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_143 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-143/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-143$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-143
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-143 proxy object. All configs
