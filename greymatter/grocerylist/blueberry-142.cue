...
Blueberry_142: {
	...
	config: [
		...
		// Blueberry_142 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_142 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-142/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-142$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-142
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-142 proxy object. All configs
