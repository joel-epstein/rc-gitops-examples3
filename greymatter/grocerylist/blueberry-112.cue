...
Blueberry_112: {
	...
	config: [
		...
		// Blueberry_112 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_112 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-112/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-112$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-112
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-112 proxy object. All configs
