...
Star_124: {
	...
	config: [
		...
		// Star_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-124
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-124 proxy object. All configs
