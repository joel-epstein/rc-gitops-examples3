...
Tangerine_137: {
	...
	config: [
		...
		// Tangerine_137 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_137 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-137/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-137$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-137
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-137 proxy object. All configs
