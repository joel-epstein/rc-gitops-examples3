...
Cranberry_105: {
	...
	config: [
		...
		// Cranberry_105 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_105 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-105/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-105$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-105
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-105 proxy object. All configs
