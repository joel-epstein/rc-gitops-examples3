...
Grape_118: {
	...
	config: [
		...
		// Grape_118 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_118 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-118/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-118$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-118
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-118 proxy object. All configs
