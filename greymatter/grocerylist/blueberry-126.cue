...
Blueberry_126: {
	...
	config: [
		...
		// Blueberry_126 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_126 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-126
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-126 proxy object. All configs
