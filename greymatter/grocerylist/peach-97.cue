...
Peach_97: {
	...
	config: [
		...
		// Peach_97 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_97 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-97/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-97$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-97
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-97 proxy object. All configs
