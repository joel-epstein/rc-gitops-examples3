...
Tangerine_126: {
	...
	config: [
		...
		// Tangerine_126 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_126 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-126
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-126 proxy object. All configs
