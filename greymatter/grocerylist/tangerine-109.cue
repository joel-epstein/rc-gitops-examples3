...
Tangerine_109: {
	...
	config: [
		...
		// Tangerine_109 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_109 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-109/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-109$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-109
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-109 proxy object. All configs
