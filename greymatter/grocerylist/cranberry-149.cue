...
Cranberry_149: {
	...
	config: [
		...
		// Cranberry_149 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_149 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-149/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-149$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-149
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-149 proxy object. All configs
