...
Cranberry_132: {
	...
	config: [
		...
		// Cranberry_132 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_132 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-132/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-132$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-132
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-132 proxy object. All configs
