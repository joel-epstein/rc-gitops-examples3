...
Kiwi_110: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-110/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-110$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-110
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-110 proxy object. All configs
