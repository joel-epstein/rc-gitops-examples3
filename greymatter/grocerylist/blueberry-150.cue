...
Blueberry_150: {
	...
	config: [
		...
		// Blueberry_150 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_150 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-150/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-150$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-150
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-150 proxy object. All configs
