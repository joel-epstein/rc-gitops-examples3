...
Melon_111: {
	...
	config: [
		...
		// Melon_111 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_111 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-111/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-111$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-111
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-111 proxy object. All configs
