...
Melon_103: {
	...
	config: [
		...
		// Melon_103 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_103 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-103/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-103$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-103
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-103 proxy object. All configs
