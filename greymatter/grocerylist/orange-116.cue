...
Orange_116: {
	...
	config: [
		...
		// Orange_116 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_116 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-116/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-116$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-116
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-116 proxy object. All configs
