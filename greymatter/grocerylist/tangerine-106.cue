...
Tangerine_106: {
	...
	config: [
		...
		// Tangerine_106 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_106 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-106/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-106$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-106
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-106 proxy object. All configs
