...
Melon_128: {
	...
	config: [
		...
		// Melon_128 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_128 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-128/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-128$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-128
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-128 proxy object. All configs
