...
Orange_129: {
	...
	config: [
		...
		// Orange_129 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_129 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-129/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-129$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-129
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-129 proxy object. All configs
