...
Melon_148: {
	...
	config: [
		...
		// Melon_148 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_148 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-148/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-148$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-148
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-148 proxy object. All configs
