...
Orange_107: {
	...
	config: [
		...
		// Orange_107 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_107 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-107/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-107$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-107
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-107 proxy object. All configs
