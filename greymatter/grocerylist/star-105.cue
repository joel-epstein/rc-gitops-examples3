...
Star_105: {
	...
	config: [
		...
		// Star_105 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Star_105 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/star-105/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/star-105$"
					to:            route_match.path
		...
		// greymatter catalog service definition for star-105
		#catalog_entry & {
			name:                      Name
		...
		// Shared star-105 proxy object. All configs
