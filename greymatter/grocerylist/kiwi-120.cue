...
Kiwi_120: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-120/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-120$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-120
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-120 proxy object. All configs
