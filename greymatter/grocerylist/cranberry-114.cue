...
Cranberry_114: {
	...
	config: [
		...
		// Cranberry_114 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_114 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-114/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-114$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-114
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-114 proxy object. All configs
