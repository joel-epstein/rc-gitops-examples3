...
Blueberry_136: {
	...
	config: [
		...
		// Blueberry_136 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_136 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-136/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-136$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-136
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-136 proxy object. All configs
