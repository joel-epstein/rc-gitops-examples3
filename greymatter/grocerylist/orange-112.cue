...
Orange_112: {
	...
	config: [
		...
		// Orange_112 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_112 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-112/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-112$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-112
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-112 proxy object. All configs
