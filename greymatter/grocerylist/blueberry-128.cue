...
Blueberry_128: {
	...
	config: [
		...
		// Blueberry_128 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_128 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-128/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-128$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-128
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-128 proxy object. All configs
