...
Blueberry_137: {
	...
	config: [
		...
		// Blueberry_137 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_137 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-137/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-137$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-137
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-137 proxy object. All configs
