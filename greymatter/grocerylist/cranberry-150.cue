...
Cranberry_150: {
	...
	config: [
		...
		// Cranberry_150 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_150 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-150/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-150$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-150
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-150 proxy object. All configs
