...
Melon_113: {
	...
	config: [
		...
		// Melon_113 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_113 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-113/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-113$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-113
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-113 proxy object. All configs
