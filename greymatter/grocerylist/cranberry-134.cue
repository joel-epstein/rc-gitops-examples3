...
Cranberry_134: {
	...
	config: [
		...
		// Cranberry_134 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_134 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-134/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-134$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-134
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-134 proxy object. All configs
