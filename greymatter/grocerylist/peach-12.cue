...
Peach_12: {
	...
	config: [
		...
		// Peach_12 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_12 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-12/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-12$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-12
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-12 proxy object. All configs
