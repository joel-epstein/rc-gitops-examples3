...
Cranberry_141: {
	...
	config: [
		...
		// Cranberry_141 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_141 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-141/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-141$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-141
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-141 proxy object. All configs
