...
Orange_101: {
	...
	config: [
		...
		// Orange_101 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_101 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-101/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-101$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-101
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-101 proxy object. All configs
