...
Blueberry_106: {
	...
	config: [
		...
		// Blueberry_106 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_106 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-106/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-106$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-106
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-106 proxy object. All configs
