...
Melon_140: {
	...
	config: [
		...
		// Melon_140 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_140 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-140/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-140$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-140
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-140 proxy object. All configs
