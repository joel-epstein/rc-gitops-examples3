...
Grape_109: {
	...
	config: [
		...
		// Grape_109 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_109 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-109/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-109$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-109
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-109 proxy object. All configs
