...
Orange_146: {
	...
	config: [
		...
		// Orange_146 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_146 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-146/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-146$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-146
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-146 proxy object. All configs
