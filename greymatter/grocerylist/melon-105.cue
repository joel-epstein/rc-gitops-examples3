...
Melon_105: {
	...
	config: [
		...
		// Melon_105 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_105 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-105/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-105$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-105
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-105 proxy object. All configs
