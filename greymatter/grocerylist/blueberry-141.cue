...
Blueberry_141: {
	...
	config: [
		...
		// Blueberry_141 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_141 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-141/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-141$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-141
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-141 proxy object. All configs
