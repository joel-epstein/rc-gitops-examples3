...
Peach_13: {
	...
	config: [
		...
		// Peach_13 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_13 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-13/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-13$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-13
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-13 proxy object. All configs
