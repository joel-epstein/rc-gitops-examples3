...
Tangerine_146: {
	...
	config: [
		...
		// Tangerine_146 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_146 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-146/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-146$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-146
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-146 proxy object. All configs
