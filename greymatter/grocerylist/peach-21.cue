...
Peach_21: {
	...
	config: [
		...
		// Peach_21 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_21 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-21/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-21$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-21
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-21 proxy object. All configs
