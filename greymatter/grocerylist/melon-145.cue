...
Melon_145: {
	...
	config: [
		...
		// Melon_145 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_145 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-145/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-145$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-145
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-145 proxy object. All configs
