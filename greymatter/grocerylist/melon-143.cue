...
Melon_143: {
	...
	config: [
		...
		// Melon_143 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_143 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-143/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-143$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-143
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-143 proxy object. All configs
