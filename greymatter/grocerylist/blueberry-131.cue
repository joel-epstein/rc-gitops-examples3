...
Blueberry_131: {
	...
	config: [
		...
		// Blueberry_131 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_131 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-131/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-131$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-131
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-131 proxy object. All configs
