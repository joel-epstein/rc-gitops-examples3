...
Peach_130: {
	...
	config: [
		...
		// Peach_130 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_130 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-130/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-130$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-130
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-130 proxy object. All configs
