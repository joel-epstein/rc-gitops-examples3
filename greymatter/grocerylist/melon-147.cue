...
Melon_147: {
	...
	config: [
		...
		// Melon_147 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_147 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-147/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-147$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-147
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-147 proxy object. All configs
