...
Orange_115: {
	...
	config: [
		...
		// Orange_115 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_115 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-115/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-115$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-115
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-115 proxy object. All configs
