...
Tangerine_128: {
	...
	config: [
		...
		// Tangerine_128 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_128 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-128/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-128$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-128
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-128 proxy object. All configs
