...
Cranberry_137: {
	...
	config: [
		...
		// Cranberry_137 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_137 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-137/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-137$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-137
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-137 proxy object. All configs
