...
Blueberry_129: {
	...
	config: [
		...
		// Blueberry_129 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_129 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-129/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-129$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-129
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-129 proxy object. All configs
