...
Blueberry_102: {
	...
	config: [
		...
		// Blueberry_102 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_102 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-102/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-102$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-102
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-102 proxy object. All configs
