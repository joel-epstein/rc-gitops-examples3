...
Tangerine_127: {
	...
	config: [
		...
		// Tangerine_127 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_127 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-127/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-127$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-127
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-127 proxy object. All configs
