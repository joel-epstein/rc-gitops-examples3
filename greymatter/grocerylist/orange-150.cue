...
Orange_150: {
	...
	config: [
		...
		// Orange_150 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_150 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-150/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-150$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-150
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-150 proxy object. All configs
