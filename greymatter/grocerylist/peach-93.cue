...
Peach_93: {
	...
	config: [
		...
		// Peach_93 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_93 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-93/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-93$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-93
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-93 proxy object. All configs
