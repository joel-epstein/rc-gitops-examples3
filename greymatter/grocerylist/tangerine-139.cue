...
Tangerine_139: {
	...
	config: [
		...
		// Tangerine_139 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_139 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-139/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-139$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-139
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-139 proxy object. All configs
