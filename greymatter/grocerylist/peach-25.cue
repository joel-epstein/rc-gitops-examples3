...
Peach_25: {
	...
	config: [
		...
		// Peach_25 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_25 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-25/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-25$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-25
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-25 proxy object. All configs
