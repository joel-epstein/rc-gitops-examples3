...
Melon_136: {
	...
	config: [
		...
		// Melon_136 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_136 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-136/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-136$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-136
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-136 proxy object. All configs
