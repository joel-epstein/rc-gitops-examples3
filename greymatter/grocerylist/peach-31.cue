...
Peach_31: {
	...
	config: [
		...
		// Peach_31 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_31 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-31/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-31$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-31
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-31 proxy object. All configs
