...
Tangerine_112: {
	...
	config: [
		...
		// Tangerine_112 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_112 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-112/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-112$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-112
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-112 proxy object. All configs
