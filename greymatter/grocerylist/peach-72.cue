...
Peach_72: {
	...
	config: [
		...
		// Peach_72 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_72 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-72/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-72$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-72
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-72 proxy object. All configs
