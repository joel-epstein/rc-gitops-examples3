...
Tangerine_149: {
	...
	config: [
		...
		// Tangerine_149 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_149 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-149/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-149$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-149
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-149 proxy object. All configs
