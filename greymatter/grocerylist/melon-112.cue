...
Melon_112: {
	...
	config: [
		...
		// Melon_112 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_112 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-112/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-112$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-112
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-112 proxy object. All configs
