...
Melon_124: {
	...
	config: [
		...
		// Melon_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-124
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-124 proxy object. All configs
