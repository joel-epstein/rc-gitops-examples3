...
Orange_121: {
	...
	config: [
		...
		// Orange_121 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_121 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-121/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-121$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-121
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-121 proxy object. All configs
