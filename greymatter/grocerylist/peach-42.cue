...
Peach_42: {
	...
	config: [
		...
		// Peach_42 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_42 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-42/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-42$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-42
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-42 proxy object. All configs
