...
Blueberry_108: {
	...
	config: [
		...
		// Blueberry_108 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_108 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-108/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-108$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-108
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-108 proxy object. All configs
