...
Peach_33: {
	...
	config: [
		...
		// Peach_33 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_33 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-33/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-33$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-33
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-33 proxy object. All configs
