...
Peach_43: {
	...
	config: [
		...
		// Peach_43 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_43 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-43/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-43$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-43
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-43 proxy object. All configs
