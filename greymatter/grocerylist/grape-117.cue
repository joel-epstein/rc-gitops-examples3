...
Grape_117: {
	...
	config: [
		...
		// Grape_117 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_117 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-117/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-117$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-117
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-117 proxy object. All configs
