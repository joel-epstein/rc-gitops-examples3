...
Tangerine_141: {
	...
	config: [
		...
		// Tangerine_141 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_141 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-141/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-141$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-141
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-141 proxy object. All configs
