...
Cranberry_129: {
	...
	config: [
		...
		// Cranberry_129 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_129 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-129/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-129$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-129
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-129 proxy object. All configs
