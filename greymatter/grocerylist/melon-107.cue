...
Melon_107: {
	...
	config: [
		...
		// Melon_107 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_107 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-107/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-107$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-107
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-107 proxy object. All configs
