...
Kiwi_125: {
	...
	config: [
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/kiwi-125/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/kiwi-125$"
					to:            route_match.path
		...
		// greymatter catalog service definition for kiwi-125
		#catalog_entry & {
			name:                      Name
		...
		// Shared kiwi-125 proxy object. All configs
