...
Orange_149: {
	...
	config: [
		...
		// Orange_149 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_149 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-149/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-149$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-149
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-149 proxy object. All configs
