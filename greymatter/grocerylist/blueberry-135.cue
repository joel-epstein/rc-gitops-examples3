...
Blueberry_135: {
	...
	config: [
		...
		// Blueberry_135 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_135 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-135/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-135$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-135
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-135 proxy object. All configs
