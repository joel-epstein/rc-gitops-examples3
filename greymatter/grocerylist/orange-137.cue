...
Orange_137: {
	...
	config: [
		...
		// Orange_137 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_137 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-137/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-137$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-137
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-137 proxy object. All configs
