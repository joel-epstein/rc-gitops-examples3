...
Blueberry_121: {
	...
	config: [
		...
		// Blueberry_121 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_121 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-121/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-121$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-121
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-121 proxy object. All configs
