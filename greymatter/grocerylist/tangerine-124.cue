...
Tangerine_124: {
	...
	config: [
		...
		// Tangerine_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-124
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-124 proxy object. All configs
