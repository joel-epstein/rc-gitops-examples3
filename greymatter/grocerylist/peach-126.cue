...
Peach_126: {
	...
	config: [
		...
		// Peach_126 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_126 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-126/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-126$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-126
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-126 proxy object. All configs
