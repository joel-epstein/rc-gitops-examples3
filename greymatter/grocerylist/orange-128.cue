...
Orange_128: {
	...
	config: [
		...
		// Orange_128 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_128 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-128/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-128$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-128
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-128 proxy object. All configs
