...
Orange_120: {
	...
	config: [
		...
		// Orange_120 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_120 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-120/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-120$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-120
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-120 proxy object. All configs
