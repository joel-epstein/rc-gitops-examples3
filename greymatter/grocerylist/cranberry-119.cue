...
Cranberry_119: {
	...
	config: [
		...
		// Cranberry_119 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_119 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-119/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-119$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-119
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-119 proxy object. All configs
