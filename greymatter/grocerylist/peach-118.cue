...
Peach_118: {
	...
	config: [
		...
		// Peach_118 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Peach_118 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/peach-118/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/peach-118$"
					to:            route_match.path
		...
		// greymatter catalog service definition for peach-118
		#catalog_entry & {
			name:                      Name
		...
		// Shared peach-118 proxy object. All configs
