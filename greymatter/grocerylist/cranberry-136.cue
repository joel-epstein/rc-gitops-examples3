...
Cranberry_136: {
	...
	config: [
		...
		// Cranberry_136 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_136 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-136/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-136$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-136
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-136 proxy object. All configs
