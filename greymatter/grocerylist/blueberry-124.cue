...
Blueberry_124: {
	...
	config: [
		...
		// Blueberry_124 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_124 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-124/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-124$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-124
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-124 proxy object. All configs
