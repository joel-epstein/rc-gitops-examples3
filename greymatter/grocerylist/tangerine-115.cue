...
Tangerine_115: {
	...
	config: [
		...
		// Tangerine_115 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_115 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-115/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-115$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-115
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-115 proxy object. All configs
