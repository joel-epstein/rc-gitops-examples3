...
Orange_103: {
	...
	config: [
		...
		// Orange_103 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_103 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-103/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-103$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-103
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-103 proxy object. All configs
