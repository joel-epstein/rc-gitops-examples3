...
Blueberry_138: {
	...
	config: [
		...
		// Blueberry_138 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_138 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-138/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-138$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-138
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-138 proxy object. All configs
