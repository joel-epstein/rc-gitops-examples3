...
Melon_129: {
	...
	config: [
		...
		// Melon_129 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_129 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-129/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-129$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-129
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-129 proxy object. All configs
