...
Melon_123: {
	...
	config: [
		...
		// Melon_123 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_123 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-123/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-123$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-123
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-123 proxy object. All configs
