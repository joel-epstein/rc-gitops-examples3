...
Blueberry_107: {
	...
	config: [
		...
		// Blueberry_107 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_107 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-107/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-107$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-107
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-107 proxy object. All configs
