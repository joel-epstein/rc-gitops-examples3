...
Tangerine_117: {
	...
	config: [
		...
		// Tangerine_117 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Tangerine_117 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/tangerine-117/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/tangerine-117$"
					to:            route_match.path
		...
		// greymatter catalog service definition for tangerine-117
		#catalog_entry & {
			name:                      Name
		...
		// Shared tangerine-117 proxy object. All configs
