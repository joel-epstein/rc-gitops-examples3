...
Melon_132: {
	...
	config: [
		...
		// Melon_132 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_132 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-132/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-132$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-132
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-132 proxy object. All configs
