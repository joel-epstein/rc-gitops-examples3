...
Blueberry_110: {
	...
	config: [
		...
		// Blueberry_110 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Blueberry_110 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/blueberry-110/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/blueberry-110$"
					to:            route_match.path
		...
		// greymatter catalog service definition for blueberry-110
		#catalog_entry & {
			name:                      Name
		...
		// Shared blueberry-110 proxy object. All configs
