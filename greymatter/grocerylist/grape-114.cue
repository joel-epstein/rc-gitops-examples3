...
Grape_114: {
	...
	config: [
		...
		// Grape_114 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_114 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-114/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-114$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-114
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-114 proxy object. All configs
