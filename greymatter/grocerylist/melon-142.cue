...
Melon_142: {
	...
	config: [
		...
		// Melon_142 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Melon_142 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/melon-142/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/melon-142$"
					to:            route_match.path
		...
		// greymatter catalog service definition for melon-142
		#catalog_entry & {
			name:                      Name
		...
		// Shared melon-142 proxy object. All configs
