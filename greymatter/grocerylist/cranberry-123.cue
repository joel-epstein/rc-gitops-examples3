...
Cranberry_123: {
	...
	config: [
		...
		// Cranberry_123 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Cranberry_123 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/cranberry-123/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/cranberry-123$"
					to:            route_match.path
		...
		// greymatter catalog service definition for cranberry-123
		#catalog_entry & {
			name:                      Name
		...
		// Shared cranberry-123 proxy object. All configs
