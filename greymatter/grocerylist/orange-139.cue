...
Orange_139: {
	...
	config: [
		...
		// Orange_139 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_139 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-139/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-139$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-139
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-139 proxy object. All configs
