...
Orange_122: {
	...
	config: [
		...
		// Orange_122 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Orange_122 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/orange-122/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/orange-122$"
					to:            route_match.path
		...
		// greymatter catalog service definition for orange-122
		#catalog_entry & {
			name:                      Name
		...
		// Shared orange-122 proxy object. All configs
