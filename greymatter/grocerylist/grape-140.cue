...
Grape_140: {
	...
	config: [
		...
		// Grape_140 -> HTTP ingress to your container
		#domain & {
		...
		// Edge config for the Grape_140 service.
		...
		#route & {
			...
			route_key:  Name
			route_match: {
				path: "/services/grocerylist/grape-140/"
			}
			redirects: [
				{
					from:          "^/services/grocerylist/grape-140$"
					to:            route_match.path
		...
		// greymatter catalog service definition for grape-140
		#catalog_entry & {
			name:                      Name
		...
		// Shared grape-140 proxy object. All configs
